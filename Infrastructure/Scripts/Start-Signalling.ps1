...
node $Entry --no_config --player_port 8880 --streamer_port 8888 --sfu_port 8889 --max_players 1 --peer_options_file "$RepoRoot/Infrastructure/local-peer-options.json"
